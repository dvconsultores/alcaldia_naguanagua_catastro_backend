...
class Inmueble(models.Model):
    ...
    status=models.ForeignKey(EstatusInmueble,on_delete=models.PROTECT,help_text="status asociado")
    ambito=models.ForeignKey(Ambito,on_delete=models.PROTECT,help_text="ambito asociado")
    sector=models.ForeignKey(Sector,on_delete=models.PROTECT,help_text="Sector asociado")
    manzana=models.ForeignKey(Manzana,on_delete=models.PROTECT,help_text="manzana asociado")
    parcela=models.ForeignKey(Parcela,on_delete=models.PROTECT,help_text="parcela asociado")
    subparcela=models.ForeignKey(SubParcela,on_delete=models.PROTECT,help_text="subparcela asociado")
    nivel=models.ForeignKey(NivelInmueble,on_delete=models.PROTECT,help_text="nivel asociado")
    unidad=models.ForeignKey(UnidadInmueble,on_delete=models.PROTECT,help_text="unidad asociado")
    urbanizacion=models.ForeignKey(Urbanizacion,on_delete=models.PROTECT,help_text="urbanizacion")
    calle=models.ForeignKey(Calle,on_delete=models.PROTECT,help_text="calle asociado")
    conjunto_residencial=models.ForeignKey(ConjuntoResidencial,on_delete=models.PROTECT,help_text="Sector asociado")
    edificio=models.ForeignKey(Edificio,on_delete=models.PROTECT,help_text="edificio asociado")
    avenida=models.ForeignKey(Avenida,on_delete=models.PROTECT,help_text="avenida asociado")
    ...
    zona = models.ForeignKey(Zona,on_delete=models.PROTECT,help_text="Zona !! Base para calculo")
    direccion = models.TextField(null=False,blank =False, unique=False, help_text="direccion")
    referencia = models.TextField(null=False,blank =False, unique=False, help_text="referencia")
