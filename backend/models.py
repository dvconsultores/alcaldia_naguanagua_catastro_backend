...
class Manzana(models.Model):
    ...
    area = models.TextField(null=False,blank =False, unique=False, help_text="Area de la manzana")
...
class Parcela(models.Model):
    ...
    area = models.TextField(null=False,blank =False, unique=False, help_text="Area de la Parcela")
...
class SubParcela(models.Model):
    ...
    area = models.TextField(null=False,blank =False, unique=False, help_text="Area de la SubParcela")
...
class Inmueble(models.Model):
    ...
    numero_civico = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    numero_casa = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    numero_piso = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    telefono = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    zona = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    direccion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    referencia = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    observaciones = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
...
class InmueblePropiedad(models.Model):
    ...
    fecha_habitabilidad	= models.DateTimeField(blank=True, help_text="fecha de inscripcion")
    ...
    area_terreno = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    ...
    area_construccion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    valor_construccion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
...
class InmuebleConstruccion(models.Model):
    inmueble = models.ForeignKey (Inmueble, on_delete=models.PROTECT,help_text="Sector asociado")
    tipo = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    uso = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    tenencia = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    regimen = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    soporte = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    techo = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    cubierta = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    tipo_pared = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    acabado_pared = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    conservacion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    anio_construccion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    anio_refaccion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    porcentaje_refaccion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    edad_efectiva = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    nveles = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    edificaciones = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    observaciones = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")

class InmuebleValoracionTerreno(models.Model):
    inmueble = models.ForeignKey (Inmueble, on_delete=models.PROTECT,help_text="Sector asociado")
    area = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    ...
    valor_unitario = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    area_factor_ajuste = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    forma_factor_ajuste	= models.ForeignKey (Forma, on_delete=models.PROTECT,help_text="Sector asociado")
    valor_ajustado = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    valor_total = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    observaciones = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
...
class InmuebleValoracionConstruccion(models.Model):
    ...
    trimestre = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    anio = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    area = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    valor = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    depreciacion = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    observaciones = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
...
class InmuebleUbicacion(models.Model):
    ...
    lindero_este = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    lindero_oeste = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    imagen_inmueble = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    imagen_plano = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
    imagan_plano_mesura = models.TextField(null=False,blank =False, unique=False, help_text="Numero de expediente")
...
class EstadoCuentaDetalle(models.Model):
    ...
    unidad_tributaria  = models.TextField(null=False,blank =False, unique=False, help_text="Cantidad Unidad tributaria")	
    cantidad  = models.TextField(null=False,blank =False, unique=False, help_text="Cantidad Unidad tributaria")
